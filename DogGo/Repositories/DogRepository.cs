        ...
        public void AddDog(Dog dog)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@imageUrl", dog.ImageUrl == null ? "https://cdn.dribbble.com/users/65090/screenshots/10698745/media/9e58b178346eba080e4877f07b336425.png?compress=1&resize=400x300" : dog.ImageUrl);
